...
app_full_name=$(ls "$script_dir/$app_type_name")

if [[ -f $app_root_path/$app_type_name/$app_full_name/libexec/init ]]; then
    echo "init $app_full_name..."
    $app_root_path/$app_type_name/$app_full_name/libexec/init
fi
